...
class Url implements UriInterface
{
     ...
     *
     * @param Url $uri The URI to be resolved against this URI
     * @return Url The resulting URI
     */
    public function resolve(Url $uri)
    {
    ...
    private function createResolve(Url $uri)
    {
     ...
     *
     * @return Url A URI equivalent to this URI, but whose path is in normal form.
     */
     ...
     * @return $this
     */
    public function getRelated(Url $baseUrl)
    {
